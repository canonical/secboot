...
type rootVarsCollector struct {
	...
	pendingUpdates map[*rootVarReader][]*varUpdate // update sequences that haven't been processed yet
	seen           map[rootVarReaderKey]struct{}   // seen starting states
	todo           []*rootVarReader                // starting states still to process
	err            error
}
