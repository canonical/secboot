...
func (e *RunChecksErrors) Errors() []error {
	return e.errs
}
...
var (
	...
	// ErrTPMLockoutAlreadyOwned is returned wrapped in TPM2DeviceError if the authorization
	...
	// ErrUnsupportedTPMOwnership is returned wrapped in TPM2DeviceError if the authorization
