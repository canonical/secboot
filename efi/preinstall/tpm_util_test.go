...
func (*tpmutilSuite) TestDeviceLockoutArgsIsValidFalse1(c *C) {
	args := TPMDeviceLockoutArgs{
...
func (*tpmutilSuite) TestDeviceLockoutArgsIsValidFalse2(c *C) {
	args := TPMDeviceLockoutArgs{
		IntervalDuration: 2 * time.Hour,
...
func (*tpmutilSuite) TestDeviceLockoutRecoveryArgIsValidFalse(c *C) {
