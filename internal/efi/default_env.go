...
var (
	...
	// dmiProcessorInfoPath is Linux sysfs naming for SMBIOS structure type 4
	// (Processor Information), instance 0. We assume that manufacturer and version
...
func (defaultEnvAMD64Impl) HasCPUIDFeature(feature uint64) bool {
	return internal_cpuid.HasFeature(feature)
}
