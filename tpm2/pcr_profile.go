...
type PCRProtectionProfileBranch struct {
	...
	currentBranchPoint *PCRProtectionProfileBranchPoint
	done               bool
}
...
//
// Further modifications to this branch after calling this function will terminate
